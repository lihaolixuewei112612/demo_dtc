...
public class MysqlSink_DP_30D extends RichSinkFunction<Tuple11<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer>> {
    ...
    public MysqlSink_DP_30D(Properties prop) {
