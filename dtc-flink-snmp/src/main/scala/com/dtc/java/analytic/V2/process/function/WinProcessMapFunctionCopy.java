 ...
 */
@Slf4j
public class WinProcessMapFunctionCopy extends ProcessWindowFunction<Tuple6<String, String, String, String, String, String>, Tuple6<String, String, String, String, String, String>, Tuple, TimeWindow> {
    ...
    public void process(Tuple tuple, Context context, Iterable<Tuple6<String, String, String, String, String, String>> iterable, Collector<Tuple6<String, String, String, String, String, String>> collector) throws Exception {
        ...
        for (Tuple6<String, String, String, String, String, String> wc : iterable) {
             ...
             * cpu使用率
             * */
            if ("101_100_101_101_101".equals(wc.f2)) {
                if (!cpuNum.containsKey(wc.f3)) {
                    cpuNum.put(wc.f3, "1");
                } else {
                    flag = true;
                }
            ...
            if (flag) {
                if ("101_100_101_101_101".equals(wc.f2)) {
                    sum += Double.parseDouble(wc.f5);
                }
                double result = sum / cpuNum.size();
                collector.collect(Tuple6.of(wc.f0, wc.f1, wc.f2, "000", wc.f4, String.valueOf(result)));
            }
            /**
             * 磁盘描述
             * */
