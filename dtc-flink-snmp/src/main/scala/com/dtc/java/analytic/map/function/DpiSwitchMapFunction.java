 ...
 * @author :hao.li
 */
public class DpiSwitchMapFunction implements MapFunction<Tuple6<String, String, String, String, String, String>, Tuple6<String, String, String, String, String, String>> {
    ...
    public Tuple6<String, String, String, String, String, String> map(Tuple6<String, String, String, String, String, String> event) throws Exception {
        ...
        if (event.f3.contains(".")) {
            ...
            return Tuple6.of(event.f0 + "|dpi_0", event.f1, result, nameCode, event.f4, event.f5);
        } else {
            return Tuple6.of(event.f0 + "|dpi_1", event.f1, event.f2 + "_" + event.f3, event.f3, event.f4, event.f5);
        }
    }
}
