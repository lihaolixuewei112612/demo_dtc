...
public class StreamToFlinkV3 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStreamSource<SourceEventDev> streamSource = env.addSource(new MySourceEvent());
...
@Slf4j
class MyMapFunctionV3 implements MapFunction<SourceEventDev,DataStruct> {
    @Override
    public DataStruct map(SourceEventDev sourceEventDev) {
        String[] codes = sourceEventDev.getCode().split("_");
        ...
        String nameCN= sourceEventDev.getName_CN();
        String nameEN= sourceEventDev.getName_CN();
        String time = sourceEventDev.getTime();
        String value = sourceEventDev.getValue();
        String host = sourceEventDev.getHost();
