...
import com.dtc.java.SC.JaShiCang.exec.Complete;
...
import static com.dtc.java.SC.JaShiCang.exec.Complete.getYcsb_lb_modelSplitStream;
...
public class DPComplete {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<Tuple3<Integer, Integer, Integer>> tuple3DataStream = First_CGroup(today_DP_WO, today_DP_BG, windowSizeMillis);
        //正常运行
        ...
        DataStream<Tuple8<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer>> tuple8DataStream = Two_CGroup(tuple3DataStream, ycsb_lb_modelSplitStream, windowSizeMillis);
        //即将维保的
        ...
        DataStream<Tuple3<Integer, Integer, Integer>> tuple3DataStream1 = First_CGroup(today_DP_JJWB, today_DP_JJFQ, windowSizeMillis);
        //(标志，维保，废弃，健康)
        DataStream<Tuple4<Integer, Integer, Integer, Integer>> tuple4DataStream = Three_CGroup(tuple3DataStream1, zsStream, windowSizeMillis).map(new MyMapFunctionV4());
