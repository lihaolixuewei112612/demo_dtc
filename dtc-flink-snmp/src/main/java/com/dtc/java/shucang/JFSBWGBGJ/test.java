...
//        wgbgiStream.keyBy("room","position").timeWindow(Time.milliseconds(windowSizeMillis)).sum("num");
//        wgbgiStream.keyBy("room","position","box").timeWindow(Time.milliseconds(windowSizeMillis)).sum("num");
//        sum.print("room");
//        /**各机房各区域各机柜健康得分*/
...
//        ycFBStream.keyBy("room", "box").timeWindow(Time.milliseconds(windowSizeMillis)).sum("num");
//        ycFBStream.keyBy("position", "box").timeWindow(Time.milliseconds(windowSizeMillis)).sum("num");
//
//        /**各机房各区域告警设备类型分布情况*/
