 ...
 */
@Slf4j
public class DaPingAlarm extends RichSourceFunction<Integer> {
...
//            String sql = "SELECT count(*) as AllNum FROM alarm WHERE TO_DAYS(time_occur) = TO_DAYS(NOW())";
            String sql = "SELECT count(*) as AllNum FROM alarm";
