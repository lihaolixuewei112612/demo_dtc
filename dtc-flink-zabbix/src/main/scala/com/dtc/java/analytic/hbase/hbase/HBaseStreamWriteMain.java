...
import static com.dtc.java.analytic.hbase.hbase.constant.HBaseConstant.*;
...
public class HBaseStreamWriteMain {
    private static final Logger logger = LoggerFactory.getLogger(HBaseStreamWriteMain.class);
