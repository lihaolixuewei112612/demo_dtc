...
import com.dtc.java.analytic.snmp.MyMapFunction;
...
public class test {
    ...
    private static final Logger logger = LoggerFactory.getLogger(com.dtc.java.analytic.zabbix.PrometheusToFlink.class);
